...
// Networks
// -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
import { arbitrumGoerli, baseGoerli, goerli, hardhat, optimism, optimismGoerli, sepolia } from '@wagmi/chains'
...
export const ETH_CHAINS_TEST = [optimism, optimismGoerli, goerli, hardhat]
export const ETH_CHAINS_PROD = [optimism]
